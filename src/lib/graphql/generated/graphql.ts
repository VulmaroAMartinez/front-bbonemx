...
export type MachineBasicFragment = { __typename?: 'Machine', id: string, code: string, name: string, description?: string | null, brand?: string | null, model?: string | null, serialNumber?: string | null, installationDate?: string | null, machinePhotoUrl?: string | null, operationalManualUrl?: string | null, isActive: boolean, subAreaId: string, createdAt: string, updatedAt: string, subArea: { __typename?: 'SubArea', id: string, name: string, area: { __typename?: 'Area', id: string, name: string, type: AreaType } } } & { ' $fragmentName'?: 'MachineBasicFragment' };
...
export type GetMachineMaterialRequestsQuery = { __typename?: 'Query', machine?: { __typename?: 'Machine', id: string, name: string, code: string, materialRequests?: Array<{ __typename?: 'MaterialRequest', id: string, folio: string, requestText: string, priority: MaterialRequestPriority, justification?: string | null, isGenericOrAlternativeModel: boolean, suggestedSupplier?: string | null, createdAt: string, materials: Array<{ __typename?: 'MaterialRequestMaterial', id: string, quantity: number, importance?: MaterialRequestImportance | null, material: { __typename?: 'Material', id: string, description: string, partNumber?: string | null, brand?: string | null } }> }> | null } | null };
